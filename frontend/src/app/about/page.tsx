    ...
    <div className="mx-auto max-w-3xl px-4 py-12 space-y-10">
      ...
      <section>
        ...
        <p className="text-sm text-muted leading-relaxed">
          {`${total} scriptures indexed across Vedanta, Yoga, Buddhist, Jain, and Sant/Bhakti traditions. ${readable} have clean readable text you can browse like a book. The remaining ${ragOnly} are older scanned texts available for AI search, but not formatted for direct reading.`}
        </p>
